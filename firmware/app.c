...
void main_init(void) {
	...
	SYNCDELAY(); EP2CFG = (bmVALID | bmBULK | bmDOUBLEBUFFERED | bmDIR);
	...
	SYNCDELAY(); FIFORESET = bmNAKALL | 4;  // reset EP6
	SYNCDELAY(); FIFORESET = bmNAKALL | 8;  // reset EP6
	SYNCDELAY(); FIFORESET = 0x00;
	SYNCDELAY(); OUTPKTEND = bmSKIP | 6;
	SYNCDELAY(); OUTPKTEND = bmSKIP | 6;
	SYNCDELAY(); EP2FIFOCFG = bmAUTOIN;
